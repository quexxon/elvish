...
func (v *codeAreaView) Render(width, height int) *term.Buffer {
...
func (v *codeAreaView) MaxHeight(width, height int) int {
	return maxHeightViaRender(v, width, height)
}
...
func maxHeightViaRender(r View, width, height int) int {
	return len(r.Render(width, height).Lines)
}
