...
func expandSimpleAbbr(simpleAbbr func(func(a, f string)), buf CodeBuffer, streak string) (CodeBuffer, bool) {
...
func expandCmdAbbr(cmdAbbr func(func(a, f string)), buf CodeBuffer, streak string) (CodeBuffer, bool) {
...
func expandSmallWordAbbr(smallWordAbbr func(func(a, f string)), buf CodeBuffer, streak string, trigger rune, categorizer func(rune) int) (CodeBuffer, bool) {
	if buf.Dot < len(buf.Content) {
